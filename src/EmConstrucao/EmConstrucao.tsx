...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <React.StrictMode>
    ...
    <div className='construction-container-master'>
        <div className='construct-image-container'> <img id = 'construction-image' src='/brasa-site/assets/under-construction-ca695d62.png' alt = 'Under construction Icon. Source: Freepik'/></div>
